...
{
    //Extension Method to convert a Customer object to CustomerDto.
    public static CustomerDto ToDto(this Customer entity) // this : to write: customer.ToDto() instead of: CustomerMapper.ToDto(customer)
    {
    ...
    {
        // Collection Expression الجديد في C# 12
        // مساوي لـ:
        // return entities.Select(e => e.ToDto()).ToList();
        // .. = spread operator
        // [.. collection] = Spread the elements into a new array
